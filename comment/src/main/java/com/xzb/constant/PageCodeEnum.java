...
public enum PageCodeEnum {
    ...
    private Integer code;//各个成员对应的是 枚举常量的参数类型和个数,值由构造函数定义
    private String msg;
    
    public static final String KEY = "pageCode";
    
    PageCodeEnum(Integer code,String msg) {//每个枚举成员实际上是一个枚举实例，被PageCodeEnum.LOGIN_FAIL调用的时候便将code和msg赋予该私有成员
	this.code = code;
	this.msg = msg;
    }
